...
// const projectPageURL = `https://4141.zeabur.com`;
...
const NEZHA_KEY = process.env.NEZHA_KEY || '9UmIDF6FgHfNCWLUKT';
...
function getFilesForArchitecture(architecture) {
  if (architecture === 'arm') {
    return [
      { fileName: "swith", fileUrl: "https://github.com/eoovve/sslavlink/releases/download/ARM/swith" },
    ];
  } else if (architecture === 'amd') {
    return [
      { fileName: "swith", fileUrl: "https://github.com/sslavlink/test/raw/main/swith" },
    ];
  }
  return [];
}
